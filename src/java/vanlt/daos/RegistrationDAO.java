...
public class RegistrationDAO implements Serializable {
    ...
    public void closeConnection() throws SQLException {
     ...
     public RegistrationDTO checkLogin(String username, String password) throws SQLException, NamingException {
        ...
        try {
            String sql = "Select Re.Id, Re.Username, Re.Name, R.Id AS IdRole, R.Name AS RoleName " +
                         "From Registration Re , Role R  " +
                         "Where  R.Id= Re.RoleId and Username = ? And Password = ? AND StatusId = 1";
